...
public class ConnectionDatabase {
	...
	private static final String DATABASE = "/estudante2";
	private static final String USER = "?user=estudante2";
	private static final String PASSWORD = "&password=estudante2";
