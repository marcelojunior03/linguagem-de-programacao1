...
public class FuncionarioValidacao {
	...
	public static List<String> validaFuncionario(Funcionario funcionario){
		...
		// Os campos Sexo e Plano de Sa�de n�o necessitam de valida��o, 
		// pois s�o obrigat�rios e seus valores s�o predefinidos:
		// Sexo: Masculino ou Feminino (ser�o usados dois componentes JRadioButton).
		// Plano de Sa�de: Sim ou N�o (ser� usado um componente JCheckBox).
