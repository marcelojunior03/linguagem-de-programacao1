...
public class ConnectionDatabase {
	...
	private static final String DATABASE = "/estudante1";
	private static final String USER = "?user=estudante1";
	private static final String PASSWORD = "&password=estudante1";
