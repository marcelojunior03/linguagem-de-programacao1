...
public class FuncionarioCadastro extends JDialog {
	...
	public FuncionarioCadastro() { // Construtor.
		...
		if (cargos != null) // Se existir pelo menos um cargo cadastrado.
			for (Cargo c : cargos)
				// O método addItem adiciona o objeto Cargo ao JComboBox. Ao ser carregado, o JComboBox chama
				// automaticamente o método toString dos objetos Cargo para convertê-los para String, pois o dado a ser
				// exibido no JComboBox deve ser deste tipo. Como o método toString foi sobrescrito na classe Cargo, 
